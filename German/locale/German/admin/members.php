...
$locale['425'] .= "Du bist dabei, den Benutzer <strong>%s</strong> zu l&ouml;schen.<br />\n";
$locale['425'] .= "Der folgende Inhalt des Benutzers wird ebenfalls entfernt:<br />\n";
$locale['425'] .= "- Artikel<br />\n";
$locale['425'] .= "- News<br />\n";
$locale['425'] .= "- Forenthemen, beachte bitte, auch die Forenbeitr&auml;ge anderer Benutzer in dem Forenthema, sowie die Umfragen und Anh&auml;nge werden ebenfalls entfernt.<br />\n";
$locale['425'] .= "- Forenbeitr&auml;ge<br />\n";
$locale['425'] .= "- Forenanh&auml;nge<br />\n";
$locale['425'] .= "- Kommentare<br />\n";
$locale['425'] .= "- Private Nachrichten, welche der Benutzer gesendet und/oder empfangen hat.<br />\n";
$locale['425'] .= "- Abstimmungen bei Umfragen<br />\n";
$locale['425'] .= "- Bewertungen<br />\n";
$locale['425'] .= "Sollte der Benutzer kein Spammer sein, empfehlen wir den Benutzer zu sperren, anonymisieren oder suspendieren.<br /><br />\n";
$locale['425'] .= "Bist du dir sicher, dass du den Benutzer l&ouml;schen m&ouml;chtest?<br />\n";
$locale['426'] = "Ja";
$locale['427'] = "Nein";
